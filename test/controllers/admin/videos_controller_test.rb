...
class Admin::VideosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_video" do
    assert_difference("Admin::Video.count") do
      post admin_videos_url, params: { admin_video: { short_description: @admin_video.short_description, title: @admin_video.title, youtube_link: @admin_video.youtube_link } }
    end
  ...
  test "should update admin_video" do
    patch admin_video_url(@admin_video), params: { admin_video: { short_description: @admin_video.short_description, title: @admin_video.title, youtube_link: @admin_video.youtube_link } }
